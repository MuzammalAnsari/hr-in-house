...
const leaveTypes = [
  { id: 1, name: "Annual Leave", code: "AL", color: "blue", icon: Plane, totalDays: 21, description: "Yearly vacation leave" },
  { id: 2, name: "Sick Leave", code: "SL", color: "red", icon: Heart, totalDays: 10, description: "Medical leave for illness" },
  { id: 3, name: "Casual Leave", code: "CL", color: "green", icon: Coffee, totalDays: 12, description: "Short-term personal leave" },
  { id: 4, name: "Unpaid Leave", code: "UL", color: "gray", icon: Briefcase, totalDays: 0, description: "Leave without pay" },
];
...
const upcomingLeaves = [
  { employee: "David Wilson", type: "Annual Leave", startDate: "2024-03-01", days: 7 },
  { employee: "Sarah Johnson", type: "Annual Leave", startDate: "2024-02-15", days: 5 },
  { employee: "Lisa Rodriguez", type: "Casual Leave", startDate: "2024-02-05", days: 1 },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {selectedTab === "overview" && (
          <>
            {/* Leave Balance Cards */}
            <div className="mb-8">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Your Leave Balance</h3>
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                {leaveBalances.map((balance, index) => {
                  const leaveType = leaveTypes.find(t => t.name === balance.type);
                      ...
                      <div className="p-5">
                        <div className="flex items-center">
                          <div className="flex-shrink-0">
                            <Icon className={`h-8 w-8 text-${leaveType?.color || 'gray'}-600`} />
                          </div>
                ...
                <div className="bg-white overflow-hidden shadow border border-gray-200 rounded-lg">
                  <div className="p-5">
                    <div className="flex items-center">
                      ...
                      <div className="ml-5 w-0 flex-1">
                        <dl>
                          <dt className="text-sm font-medium text-gray-500 truncate">People on Leave</dt>
                          <dd className="text-lg font-medium text-gray-900">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white shadow border border-gray-200 rounded-lg overflow-hidden">
                <div className="px-4 py-5 sm:p-6">
                  <h3 className="text-lg font-medium text-gray-900 mb-4">Upcoming Leaves</h3>
                    ...
                    {upcomingLeaves.map((leave, index) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-200">
                        <div className="flex items-center">
                          ...
                          <div>
                            <div className="text-sm font-medium text-blue-800">{leave.employee}</div>
                            <div className="text-xs text-blue-600">{leave.type} • {leave.days} days</div>
                          </div>
                        </div>
                      ...
                      <div key={request.id} className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm text-gray-900">
                            <span className="font-medium">{request.employeeName}</span> applied for{" "}
        ...
        {selectedTab === "calendar" && (
          <div className="bg-white shadow border border-gray-200 rounded-lg overflow-hidden">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg font-medium text-gray-900 mb-6">Leave Calendar</h3>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                <div className="lg:col-span-3">
                  <div className="bg-gray-50 rounded-lg p-8 text-center">
                    ...
                    <p className="text-gray-600">Interactive calendar showing all employee leaves would be displayed here.</p>
                  </div>
                </div>

                <div>
                  <h4 className="text-md font-medium text-gray-900 mb-4">Legend</h4>
                  <div className="space-y-3">
                    {leaveTypes.map((type) => {
                      const Icon = type.icon;
                      return (
                        <div key={type.id} className="flex items-center">
                          <div className={`w-4 h-4 rounded bg-${type.color}-500 mr-3`} />
                          <Icon className={`h-4 w-4 text-${type.color}-600 mr-2`} />
                  ...
                  <div className="mt-6">
                    <h5 className="text-sm font-medium text-gray-900 mb-3">Quick Filters</h5>
                    <div className="space-y-2">
                      <label className="flex items-center">
                        <input type="checkbox" defaultChecked className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded mr-2" />
                        <span className="text-sm text-gray-700">Show all leaves</span>
                      </label>
                      <label className="flex items-center">
                        <input type="checkbox" className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded mr-2" />
                        <span className="text-sm text-gray-700">My team only</span>
                      </label>
                      <label className="flex items-center">
                        <input type="checkbox" className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded mr-2" />
        ...
        {selectedTab === "policies" && (
          <div className="space-y-6">
            <div className="bg-white shadow border border-gray-200 rounded-lg overflow-hidden">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg font-medium text-gray-900 mb-6">Leave Policies</h3>
                    ...
                    return (
                      <div key={type.id} className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-center mb-3">
                          <Icon className={`h-6 w-6 text-${type.color}-600 mr-3`} />
                          <div>
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            <span className="text-gray-600">Annual Allocation:</span>
                            <span className="font-medium">{type.totalDays > 0 ? `${type.totalDays} days` : "Unlimited"}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Carry Forward:</span>
                            <span className="font-medium">{type.name === "Annual Leave" ? "5 days max" : "Not allowed"}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Notice Period:</span>
                            <span className="font-medium">
                              {type.name === "Annual Leave" ? "2 weeks" : type.name === "Sick Leave" ? "Same day" : "3 days"}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Documentation:</span>
                            <span className="font-medium">
                              {type.name === "Sick Leave" ? "Medical certificate for 3+ days" : "Not required"}
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <ul className="mt-2 text-sm text-blue-700 space-y-1">
                        <li>• Leave requests must be submitted through this system</li>
                        <li>• Manager approval is required for all leave types</li>
                        <li>• HR approval required for leaves exceeding 5 consecutive days</li>
                        <li>• Emergency leave can be applied retroactively within 48 hours</li>
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                        <div className="space-y-1 text-center">
                          ...
                          <p className="text-xs text-gray-500">Medical certificates, travel documents, etc.</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                      <div className="flex">
                        ...
                        <div>
                          <h4 className="text-sm font-medium text-yellow-800">Leave Balance Check</h4>
                          <p className="mt-1 text-sm text-yellow-700">
                            Annual Leave: 13 days remaining | This request will use 5 days
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-900">{selectedRequest.employeeName}</p>
                        <p className="text-xs text-gray-500">{selectedRequest.employeeId} • {selectedRequest.department}</p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">{selectedRequest.days} days</p>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-900">{selectedRequest.manager}</p>
                      </div>
